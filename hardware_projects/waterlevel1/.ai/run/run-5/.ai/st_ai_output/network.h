...
#define STAI_NETWORK_ORIGIN_MODEL_NAME         "large_ar_mlp"
#define STAI_NETWORK_ORIGIN_MODEL_SIGNATURE    "0x968248df27fcbf0daa0954501331a5b3"

/*  Generated model name and signature  */
#define STAI_NETWORK_MODEL_NAME                "network"
#define STAI_NETWORK_MODEL_SIGNATURE           (0x1a55bb6c754cbcd3)
...
#define STAI_NETWORK_IN_1_SHAPE       {1,23}
#define STAI_NETWORK_IN_1_BATCH       (1)
#define STAI_NETWORK_IN_1_CHANNEL     (23)
#define STAI_NETWORK_IN_1_RANK        (1)
#define STAI_NETWORK_IN_1_SIZE        (23)
#define STAI_NETWORK_IN_1_SIZE_BYTES  (92)
...
#define STAI_NETWORK_ACTIVATIONS_SIZE              (476)
#define STAI_NETWORK_ACTIVATIONS_SIZE_BYTES        (476)
...
#define STAI_NETWORK_ACTIVATION_1_SIZE       (476)
#define STAI_NETWORK_ACTIVATION_1_SIZE_BYTES (476)
...
#define STAI_NETWORK_WEIGHTS_SIZE                  (30728)
#define STAI_NETWORK_WEIGHTS_SIZE_BYTES            (30728)
...
#define STAI_NETWORK_WEIGHT_1_SIZE        (30728)
#define STAI_NETWORK_WEIGHT_1_SIZE_BYTES  (30728)
