...
def main():
    ...
    parser.add_argument("--port", type=str, default="/dev/ttyUSB0", help="Serial port (e.g., COM3, /dev/ttyUSB0)")
    parser.add_argument("--baud", type=int, default=115200, help="Baud rate")
    parser.add_argument("--dataset", type=str, default="data-july1-14_outage.csv", help="Path to the test dataset")
